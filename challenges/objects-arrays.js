...
const sharpTooth = new dinosaur("tyrannosaurus", "carnivorous", "7000kg", "12m", "Late Cretaceous")
console.log(sharpTooth)

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const spike = new dinosaur("stegosaurus", "herbivorous", "2000kg", "9m", "Late Jurassic")
console.log(spike)
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const blue = new dinosaur("velociraptor", "carnivorous", "15kg", "1.8m", "Late Cretaceous")
console.log(blue)
...
*/
const lowerPopulation = [];//***** I changed name from largerPopulation to lowerPopulation *****
lowerPopulation.push(...zooAnimals.filter(animal => animal.population < 5))
...
*/
let populationTotal = 0;//****** I changed declaration to let instead of const ***** 
