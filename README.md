...
1. Describe the biggest difference between `.forEach` & `.map`.
    forEach can mutate the calling array, map will return a new array

2. What is the difference between a function and a method?
    All methods are functions but not all functions are methods, a method is just a function that belongs to an object.

3. What is closure?
    closure is the scope of a function and the accessibility of objects
...
5. Why do we need super() in an extended class?
    because super() calls up to the Parent class in order to grab any attributes belonging to the Parent class
    like a handshake from parent to child
